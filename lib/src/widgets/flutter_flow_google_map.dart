...
class _FlutterFlowGoogleMapState extends State<FlutterFlowGoogleMap> {
  ...
  LatLng get initialPosition =>
      widget.initialLocation?.toGoogleMaps() ?? const LatLng(0, 0);
  ...
  void initializeMarkerBitmap() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((final _) {
      ...
      imageProvider.resolve(imageConfiguration).addListener(
        ImageStreamListener((final img, final _) async {
  ...
  @override
  void didUpdateWidget(final FlutterFlowGoogleMap oldWidget) {
  ...
  @override
  Widget build(final BuildContext context) => AbsorbPointer(
        ...
        child: GoogleMap(
          ...
          onCameraMove: (final position) => currentMapCenter = position.target,
